...
webhookUrl = 'https://discord.com/api/webhooks/yourwebhookurlhere' -- Change this to your discord webhook url
...
-- 911 Script for FiveM |
														Developed by Dev.ian
...
function sendDiscord(name, message)
	local content = {
        {
        	["color"] =  "5263615",
            ["title"] = "**There is a New 911 Report**",
            ["description"] = message,
        }
    }
